...
var CustomError, StreamReceiver, StreamSender,
  __hasProp = {}.hasOwnProperty,
  __extends = function(child, parent) { for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; } function ctor() { this.constructor = child; } ctor.prototype = parent.prototype; child.prototype = new ctor(); child.__super__ = parent.prototype; return child; };
...
exports.GroupedInput = function(component, config, proc) {
  var collectGroups, groupedData, groupedDataGroups, inPorts, name, outPorts, port, processQueue, q, _fn, _i, _j, _k, _len, _len1, _len2;
  ...
  _fn = function(port) {
    ...
    inPort.groups = [];
    return inPort.process = function(event, payload) {
      var data, g, groups, grp, key, out, outs, p, requiredLength, whenDone, _l, _len3, _len4, _len5, _len6, _len7, _m, _n, _o, _p, _ref;
      switch (event) {
        case 'begingroup':
        ...
        case 'data':
          ...
          if (requiredLength === 1 || Object.keys(groupedData[key]).length === requiredLength) {
            ...
            outs = {};
            for (_n = 0, _len5 = outPorts.length; _n < _len5; _n++) {
              name = outPorts[_n];
            ...
            whenDone = function(err) {
              ...
              if (outPorts.length === 1) {
                if (config.forwardGroups) {
                  for (_o = 0, _len6 = groups.length; _o < _len6; _o++) {
                    g = groups[_o];
                    outs.endGroup();
                  }
                }
                ...
                for (name in outs) {
                  out = outs[name];
                  if (config.forwardGroups) {
                    for (_p = 0, _len7 = groups.length; _p < _len7; _p++) {
                      g = groups[_p];
                      out.endGroup();
                    }
                  }
  ...
  for (_k = 0, _len2 = inPorts.length; _k < _len2; _k++) {
    port = inPorts[_k];
    _fn(port);
  }
  return component;
